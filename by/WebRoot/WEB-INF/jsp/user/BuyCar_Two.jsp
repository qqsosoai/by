                ...
                <c:forEach items="${list}" var="Category1">   
                    <li>
                        ...
                        <c:forEach items="${Category1.list}" var="Category2">
                            ...
                            <div class="zj_r">
                                <a href="javascript:;"><img src="static/images/n_img1.jpg" width="236" height="200" /></a>
                                <a href="javascript:;"><img src="static/images/n_img2.jpg" width="236" height="200" /></a>
                            </div>
                        </div>
                    </li>
                  </c:forEach> 
...
<div class="i_bg">  
    ...
    <div class="content mar_20">
    	<div class="two_bg">
        	<div class="two_t">
            	<span class="fr"><a href="pay.html?method=toCar">修改</a></span>商品列表
            </div>
            <table border="0" class="car_tab" style="width:1110px;" cellspacing="0" cellpadding="0">
              ...
              <tr <c:if test="${s.count%2==0}">class="car_tr"</c:if>>
                <td>
                    <div class="c_s_img"><img src="static/images/files/${product.productId.fileName}" width="73" height="73" /></div>
                    ${product.productId.name}
                </td>
                <td align="center">颜色：灰色</td>
                <td align="center" name="num">${product.proNum}</td>
                <td align="center" style="color:#ff4e00;">￥<span name="price">${product.productId.price}</span></td>
                <td align="center">26R</td>
              </tr>
              </c:forEach>
                <td colspan="5" align="right" style="font-family:'Microsoft YaHei';">
                    商品总价：￥<span id="pay">1899.00</span>;
                </td>
              </tr>
            </table>
            
            <div class="two_t">
            	<span class="fr"><a href="user.html?method=toUserAddress">修改</a></span>收货人信息
            </div>
            <table border="0" class="peo_tab" style="width:1110px;" cellspacing="0" cellpadding="0">
              <c:forEach items="${userAddress}" var="address">
              <tr>
                <td class="p_td" width="160">
                <input type="radio" name="userAddress" value="${address.id}" <c:if test="${address.isDefault==1}">checked</c:if>/><c:if test="${address.province.areacode==''}">${address.province.areaname}</c:if>
                &nbsp;${address.city.areaname}
                &nbsp;${address.zone.areaname}
                &nbsp;${address.detail}
                &nbsp;<b>（${address.collect}）</b>
                &nbsp;<b>${address.phone}</b>
                </td>
            ...
            <table border="0" style="width:900px; margin-top:20px;" cellspacing="0" cellpadding="0">
              <tr>
                <td align="right">
                    商品总价: <font color="#ff4e00">￥<span name="isPay">1815.00</span></font>
                </td>
              </tr>
              <tr height="70">
                <td align="right">
                	<b style="font-size:14px;">应付款金额：<span style="font-size:22px; color:#ff4e00;">￥<span name="isPay">1815.00</span></span></b>
                </td>
              </tr>
              <tr height="70">
                <td align="right"><a href="#"><img src="static/images/btn_sure.gif" /></a></td>
              </tr>
            </table>
        </div>
    </div>
