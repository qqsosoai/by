...
<div class="soubg">
	<div class="sou">
        <span class="fr">
        	<span class="fl">你好，请<a href="login.html?method=login">登录</a>&nbsp; <a href="#" style="color:#ff4e00;">免费注册</a>&nbsp; </span>
            ...
            <table border="0" style="width:420px; font-size:14px; margin-top:20px;" cellspacing="0" cellpadding="0">
              <tr height="50" valign="top">
                ...
                <td>
                    ...
                    <span class="fr">已有商城账号，<a href="login.html?method=login" style="color:#ff4e00;">我要登录</a></span>
                </td>
              </tr>
              <tr height="50">
              ...
              <tr height="50">
                ...
                <td><input type="password" name="rPassword" id="rPassword" value="" class="l_pwd" /></td>
              </tr>
              <tr height="50">
              ...
              <tr height="50">
                ...
                <td><input type="text" name="phone" id="phone" value="" class="l_tel" /></td>
              </tr>
              <tr height="50">
                <td align="right">姓名 &nbsp;</td>
                <td><input type="text" name="userName" id="userName" value="" class="l_mem" /></td>
              </tr>
              <tr height="50">
                <td align="right">身份证号码 &nbsp;</td>
                <td><input type="text" name="identityCode" id="identityCode" value="" class="l_mem" /></td>
              </tr>
              <tr height="50">
              ...
              <tr>
                ...
                <td style="font-size:12px; padding-top:20px;">
                	<span style="font-family:'宋体';" class="fl">
                    	<label class="r_rad"><input type="checkbox" name="ckeck" /></label><label class="r_txt">我已阅读并接受《用户协议》</label>
                    </span>
                </td>
              </tr>
              <tr height="60">
...
<script src="static/js/private/regist.js"></script>
