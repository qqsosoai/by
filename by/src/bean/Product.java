...
public class Product implements Serializable,Cloneable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7717092329804396129L;
	private Integer id;//主键
	private String name;//名称
	private String description;//描述
	private Float price;//价格
	private Integer stock;//库存
	private Integer categoryLevel1Id;//一级分类1
	private Integer categoryLevel2Id;//二级分类2
	private Integer categoryLevel3Id;//三级分类3
	...
	public String toString() {
		return "Prodect [id=" + id + ", name=" + name + ", description="
